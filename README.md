...
| **원현섭** | **Developer** | Photon 네트워크 동기화, Firebase 백엔드 연동, 매칭 시스템 | [@GitHubID](https://github.com/Uhyun7) |
| **김태건** | **Designer/Dev** | UI/UX 기획 및 디자인, 로비/인게임 UI 구현 | [@GitHubID](https://github.com/taegeon1226-dotcom)|
