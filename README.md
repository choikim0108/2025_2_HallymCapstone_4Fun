...
* **[세션 관리]** 교사(Host)가 학습 맵(개발 완료된 맵 : 우체국)을 생성하고, 학생(Client)들은 고유 세션 코드를 통해 참여합니다.
* **[AI 보조 교사]** 프롬프트 엔지니어링이 적용된 gpt-4o 기반의 AI 힌트 시스템이 학생들의 학습을 실시간으로 보조합니다.
* **[음성 인식 및 분석]** 학생의 음성을 녹음/추출하고, WhisperX 기반 AI 모델로 발음 및 유창성을 분석하여 정량화된 **학습 리포트**를 생성합니다.
...
* **[플레이어 커스터마이징]** Firebase와 연동된 아바타 커스터마이징 기능을 인게임 재화로 제공합니다.
